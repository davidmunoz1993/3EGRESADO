...
{
    public class InformacionProfesionalEgresadoesController : Controller
    {
        private pureba2registerContext db = new pureba2registerContext();

        // GET: InformacionProfesionalEgresadoes
        ...
        // GET: InformacionProfesionalEgresadoes/Details/5
        ...
        // GET: InformacionProfesionalEgresadoes/Create
        ...
        // POST: InformacionProfesionalEgresadoes/Create
        ...
        // GET: InformacionProfesionalEgresadoes/Edit/5
        ...
        // POST: InformacionProfesionalEgresadoes/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: InformacionProfesionalEgresadoes/Delete/5
        ...
        // POST: InformacionProfesionalEgresadoes/Delete/5
